...
# 7. Slider
age = st.slider("Select your age", 0, 100, 25) # 0 the start of the slider, 100 the stop and 25 where is going to
st.write(f"Your age is: {age}") # show the default value
